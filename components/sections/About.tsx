...
const About: React.FC = () => {
  return (
      <section className="py-20 lg:py-40 px-6 lg:px-8 relative bg-sacred-green-light/5 overflow-hidden">
        {/* Abstract Background Shapes */}
        <div className="absolute top-20 left-1/4 w-96 h-96 bg-sacred-gold/5 rounded-full blur-[100px] pointer-events-none" />
        
        <div className="max-w-[100rem] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div className="lg:col-span-4 relative group">
                ...
                <div className="relative h-[500px] lg:h-[800px] w-full rounded-[1rem] overflow-hidden shadow-2xl filter grayscale-[0.2] contrast-110 group-hover:grayscale-0 transition-all duration-1000">
                    <img 
                    ...
                    <div className="absolute bottom-8 left-8 lg:bottom-12 lg:left-12 text-white">
                        <div className="font-serif text-4xl lg:text-5xl font-bold">Alexandre V.</div>
                        <div className="text-sacred-gold uppercase tracking-[0.3em] text-[10px] lg:text-xs mt-2">Fondateur & Thérapeute</div>
                    </div>
                </div>
            </div>
            ...
            <div className="lg:col-span-8 relative">
                <Quote className="absolute -top-10 -left-10 w-20 h-20 lg:w-32 lg:h-32 text-sacred-gold/5 rotate-180" />
                ...
                <div className="pl-0 lg:pl-10">
                    ...
                    <h2 className="font-serif text-6xl lg:text-7xl xl:text-9xl text-sacred-cream mb-10 lg:mb-12 leading-[0.9]">
                        L'Alchimiste <br/><span className="text-sacred-gold italic pl-20">Moderne</span>
                    </h2>
                    
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 mb-10 lg:mb-12">
                         <p className="text-lg lg:text-xl text-sacred-cream/80 font-light leading-loose text-justify">
                    ...
                    <div className="bg-white/5 border-l-4 border-sacred-gold p-6 lg:p-8 rounded-r-2xl mb-10 lg:mb-12">
                        <p className="font-serif text-2xl lg:text-3xl text-sacred-gold italic leading-normal">
                    ...
                    <div className="grid grid-cols-3 gap-8 border-t border-white/10 pt-10">
                        <div>
                            <span className="block text-4xl lg:text-5xl font-serif text-white mb-2">10+</span>
                            <span className="text-[10px] lg:text-xs uppercase tracking-widest text-sacred-cream/40">Années Pratique</span>
                        </div>
                        <div>
                            <span className="block text-4xl lg:text-5xl font-serif text-white mb-2">2k</span>
                            <span className="text-[10px] lg:text-xs uppercase tracking-widest text-sacred-cream/40">Patients</span>
                        </div>
                        <div>
                            <span className="block text-4xl lg:text-5xl font-serif text-white mb-2">∞</span>
                            <span className="text-[10px] lg:text-xs uppercase tracking-widest text-sacred-cream/40">Vies Changées</span>
                        </div>
                    </div>
                </div>
            </div>
