...
const About: React.FC = () => {
  return (
      <section className="py-20 lg:py-24 xl:py-40 px-6 lg:px-8 relative bg-sacred-green-light/5 overflow-hidden">
        {/* Abstract Background Shapes */}
        <div className="absolute top-20 left-1/4 w-96 h-96 bg-sacred-gold/5 rounded-full blur-[100px] pointer-events-none" />
        
        <div className="max-w-[100rem] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-20 items-center">
            ...
            <div className="lg:col-span-4 relative group">
                ...
                <div className="relative h-[400px] lg:h-[600px] xl:h-[800px] w-full rounded-[1rem] overflow-hidden shadow-2xl filter grayscale-[0.2] contrast-110 group-hover:grayscale-0 transition-all duration-1000">
                    <img 
            ...
            <div className="lg:col-span-8 relative">
                <Quote className="absolute -top-6 -left-6 lg:-top-10 lg:-left-10 w-16 h-16 lg:w-32 lg:h-32 text-sacred-gold/5 rotate-180" />
                
                <div className="pl-0 lg:pl-10">
                    <span className="text-sacred-gold uppercase tracking-[0.4em] font-bold text-[10px] lg:text-xs block mb-6 lg:mb-8 flex items-center gap-4">
                        <span className="w-8 lg:w-12 h-[1px] bg-sacred-gold"></span>
                        Le Guide
                    </span>
                    
                    <h2 className="font-serif text-5xl lg:text-6xl xl:text-8xl text-sacred-cream mb-8 lg:mb-12 leading-[0.9]">
                    ...
                    <div className="bg-white/5 border-l-4 border-sacred-gold p-6 lg:p-8 rounded-r-2xl mb-8 lg:mb-12">
                    ...
                    {/* Stats Horizontal */}
                    <div className="grid grid-cols-3 gap-8 border-t border-white/10 pt-8 lg:pt-10">
                        <div>
